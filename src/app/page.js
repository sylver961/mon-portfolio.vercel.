...
export default function Home() {
  return (
    <main>
      ...
      {/* Hero Section */}
      <section className="section" id="home" style={{ paddingTop: '8rem', textAlign: 'center' }}>
        <div className="container animate-fade-in">
          <p style={{ color: 'var(--accent-primary)', fontWeight: 'bold', marginBottom: 'var(--space-sm)' }}>
          ...
          <p style={{ fontSize: '1.25rem', maxWidth: '600px', margin: '0 auto var(--space-lg)', color: 'var(--text-secondary)' }}>
          ...
          <SocialIcons style={{ marginBottom: 'var(--space-md)' }} />
          <div style={{ display: 'flex', gap: 'var(--space-md)', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="#contact" className="btn btn-primary">Me contacter</a>
            {/* Downloadable CV Link */}
            <a href="/cv.pdf" download="Mon_CV_Developpeur.pdf" className="btn btn-outline">
      ...
      <section className="section" id="contact" style={{ background: 'var(--bg-secondary)' }}>
        <div className="container">
          ...
          <p style={{ textAlign: 'center', color: 'var(--text-secondary)', marginBottom: 'var(--space-xl)', maxWidth: '600px', margin: '0 auto var(--space-xl)' }}>
